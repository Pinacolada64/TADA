...
register_topic(
    ...
    help_obj=Help(
        ...
        description=(
            ...
            "Being mounted also has a downside with melee weapons: "
            "you're swinging from up in the saddle, so you can miss "
            "over the top of a short monster entirely. "
        ...
        admin_notes=[
            ...
            "player_attacks(is_charge=True). Miss-over-the-top: "
