...
flavor text is lost (no MESSAGES.TXT); travel4 always prints "YOU HAVE
ENTERED <level name>!".
...
def _make_map() -> Map:
    ...
    room89 = Room(number=89, name='TELEPORT ROOM', desc='',
                  ...
                  hidden_exit_east={'room': 41, 'level': 5,
                                    'message': ['Suddenly, a gust of wind!']})
...
class TestRoom89Teleport(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_room_message_18_sent_before_level_banner(self):
        ...
        self.assertIn('Suddenly, a gust of wind!', sent)
